...
# Ao terminar o Curso Python Progressivo, você foi disputado a tapa por várias empresas, 
# e uma grande varejista te ofereceu o salário maior.

# Sua primeira tarefa é criar um programa em Python que pede o preço original de um produto
#  e dá 20% de desconto.
